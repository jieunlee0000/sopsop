...
function HomeBrandStory() {
        ...
        <section className="home__brand-story" ref={containerRef}>
            <div className="home__brand-story-inner">
                ...
                <div className="home__brand-story-block home__brand-story-block--genesis">
                    ...
                    <div className="home__brand-story-icon home__brand-story-icon--genesis">
    ...
    C112 241 106 268 106 291"
                    ...
                    <div className="home__brand-story-content home__brand-story-content--genesis">
                ...
                <div className="home__brand-story-block home__brand-story-block--heritage">
                    ...
                    <div className="home__brand-story-icon home__brand-story-icon--heritage">
                        <svg
                            width="329"
                            height="169"
                            viewBox="0 0 329 169"
                    ...
                    <div className="home__brand-story-content home__brand-story-content--heritage">
                ...
                <div className="home__brand-story-block home__brand-story-block--presence">
                    ...
                    <div className="home__brand-story-icon home__brand-story-icon--presence">
                    ...
                    <div className="home__brand-story-content home__brand-story-content--presence">
