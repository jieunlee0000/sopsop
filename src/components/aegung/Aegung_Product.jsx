...
const productData = [
    ...
    },
    {
        ...
        desc: <>자연과 궁궐이 가장 완벽하게 어우러진 곳, 창덕궁의 <span className='FB'>고귀한 정취</span>를 향으로 재해석한 특별한 바디 케어 세트입니다. 비대칭의 미학 속에 숨겨진 비밀스러운 후원을 거닐듯, 일상의 샤워 시간을 <span className='FB'>깊은 사유와 회복의 의식</span>으로 채워줍니다.</>,
        notes: [
    ...
    },
    {
        ...
        desc: <>샌달우드 바디 워시로 마음을 정돈한 뒤, <span className='FB'>아이리스</span> 바디 로션을 레이어링해 보세요. 창덕궁의 숲길을 걷다 우연히 마주친 <span className='FB'>꽃 향기</span>처럼, 입체적이고 신비로운 <span className='FB'>당신만의 향기 궤적</span>을 만들 수 있습니다.</>,
        notes: [
